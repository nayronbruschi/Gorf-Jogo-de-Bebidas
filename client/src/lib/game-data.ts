...
const spicyChallenges: Challenge[] = [
  { text: "Vá para o quarto com alguém da roda", icon: Flame },
  { text: "Beije o jogador(a) da sua frente", icon: Heart },
  { text: "Acaricie as partes íntimas do jogador ao seu lado", icon: Hand },
  { text: "Faça uma massagem sensual em alguém do grupo", icon: Hand },
  { text: "Escolha alguém para fazer um strip-tease", icon: Flame },
  { text: "Dance sensualmente no colo de alguém", icon: Activity },
  { text: "Dê um beijo de língua em alguém", icon: Heart },
  { text: "Faça uma carícia ousada em alguém", icon: Hand },
  { text: "Tire uma peça de roupa", icon: Flame },
  { text: "Deixe alguém dar um chupão em você", icon: Heart },
  { text: "Beije três pessoas diferentes", icon: Heart },
  { text: "Escolha alguém para um momento quente", icon: Flame },
  { text: "Faça uma pose sensual", icon: Heart },
  { text: "Demonstre sua posição favorita", icon: Flame },
  { text: "Dê um selinho em todos do grupo", icon: Heart }
];
